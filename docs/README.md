...
| [Configuration and runtime](configuration-and-runtime.md) | Configuration or runtime operator | Global canonical history, projection, check/apply, lifecycle, and rollback | `internal/configuration`, configuration application services, `internal/runtime`, and activation storage |
