...
| KEY-01 | Store key migration/accounting, public delivery and key panel; [subscription guide](subscriptions-and-observability.md) | Migration/24-request concurrency tests, cross-channel quota HTTP tests, expiry/revocation/304/failure accounting, explicit secret-read authorization, persistence and UI tests |
