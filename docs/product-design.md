...
| SET-04 | Traffic quota, language, theme, five presets/custom color picker with HEX and explicit apply/cancel after closing; default #6D4ED1, radius 0–32 default24 | Persisted preferences and preview transaction | Save/reload, category switch retains draft, leaving restores saved; reset only color/radius | implemented |
