...
| UI-02 | Transparent 20px action icons in 40px targets; consistent hover/pressed/focus; centered dialogs; compact semantic-color Toast; no duplicate headings/footers | Shared UI and feedback | Real actions, focus return, Escape, visible validation, no false success | implemented |
