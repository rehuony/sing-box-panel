...
func render(components []component) ([]byte, error) {
	...
	output.WriteString("linked into the supported linux/amd64 or linux/arm64 binary, and every\n")
	...
	output.WriteString("For versions with native Schema support, the panel binary embeds one canonical Schema\n")
	output.WriteString("derived from the exact official Linux release binary's native output. This asset is an\n")
	output.WriteString("auditable GPL-3.0-or-later derived work; sing-box source and binaries are not bundled.\n")
