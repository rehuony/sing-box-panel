...
// The 1.13 projector owns the reviewed sing-box 1.13 configuration behavior.
package singbox
...
func projectV113(_ string, request configuration.ProjectionRequest) (configuration.ProjectionResult, error) {
