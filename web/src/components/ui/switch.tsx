...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        'peer group/switch relative inline-flex h-11 shrink-0 items-center rounded-full border border-transparent bg-transparent outline-none transition-[border-color,box-shadow] group-has-[:focus-visible]/field-label:border-transparent group-has-[:focus-visible]/field-label:ring-0 data-[size=default]:w-14 data-[size=sm]:w-11 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 data-disabled:cursor-not-allowed data-disabled:opacity-50',
        className,
      )}
      {...props}
    >
